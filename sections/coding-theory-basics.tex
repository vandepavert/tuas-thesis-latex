        ...
        \begin{center}
            \adjustbox{valign=t}{%
                \begin{minipage}[t]{0.455\textwidth}
                    \raggedright
                    \caption{Addition for $GF(4)=\{0,1,2,3\}$}
            ...
            \adjustbox{valign=t}{%
                \begin{minipage}[t]{0.505\textwidth}
                    \raggedright
                    \caption{Multiplication for $GF(4)=\{0,1,2,3\}$}
        ...
        \begin{center}
            \adjustbox{valign=t}{%
                \begin{minipage}[t]{0.46\textwidth}
                    \raggedright
                    \caption{Addition for $GF(4)=\{0, 1, a, b\}$}
            ...
            \adjustbox{valign=t}{%
                \begin{minipage}[t]{0.50\textwidth}
                    \raggedright
                \caption{Multiplication for $GF(4)=\{0, 1, a, b\}$}
        ...
        \adjustbox{valign=t}{%
            \begin{minipage}[t]{0.4\textwidth}
                \begin{tikzpicture}[
                    ...
                    % grid
                    \draw[dotted, thin,color=gray] (-0.1,-0.1) grid (1.1,1.1);
                    ...
                    % nodes
                    \node (n00) at (0,0) [dot, label=below left:{(0,0)}];
                    \node (n01) at (0,1) [dot, label=below left:{(0,1)}];
                    \node (n10) at (1,0) [dot, label=below right:{(1,0)}];
                    \node (n11) at (1,1) [dot, label=below right:{(1,1)}];
        ...
        \adjustbox{valign=t}{%
            \begin{minipage}[t]{0.5\textwidth}
                \begin{tikzpicture}[
                    ...
                    % axes
                    \draw[->] (0,0,0) -- (xyz cylindrical cs:radius=1.2) node[right] {$x_1$};
                    \draw[->] (0,0,0) -- (xyz cylindrical cs:radius=1.2,angle=90) node[above] {$x_2$};
                    \draw[->] (0,0,0) -- (xyz cylindrical cs:z=1.2) node[below right] {$x_3$};

                    % nodes
                    \node (n000) at (0,0,0) [dot, label=below right:{(0,0,0)}];
                    \node (n001) at (0,0,1) [dot, label=above left:{(0,0,1)}];
                    \node (n010) at (0,1,0) [dot, label=above left:{(0,1,0)}];
                    \node (n011) at (0,1,1) [dot, label=above left:{(0,1,1)}];

                    \node (n100) at (1,0,0) [dot, label=below right:{(1,0,0)}];
                    \node (n101) at (1,0,1) [dot, label=below right:{(1,0,1)}];
                    \node (n110) at (1,1,0) [dot, label=above right:{(1,1,0)}];
                    \node (n111) at (1,1,1) [dot, label=above left:{(1,1,1)}];

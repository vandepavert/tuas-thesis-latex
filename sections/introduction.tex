    ...
    \begin{figure}[htp]
        \begin{center}
            \begin{tikzpicture}[
                ...
                %Lines
                \draw[->,line width=1pt] (sender.east) -- (encoder.west);
                \draw[->,line width=1pt] (encoder.east) -- (channel.west) node[midway,above] {c};

                \draw[->,line width=1pt] (noise.south) -- (channel.north);

                \draw[->,line width=1pt] (channel.east) -- (decoder.west) node[midway,above] {r};
                \draw[->,line width=1pt] (decoder.east) -- (receiver.west);
            \end{tikzpicture}
        \end{center}
    ...
    \begin{figure}[htp]
        \begin{center}
            \begin{tikzpicture}[
                ...
                \draw[->,line width=1pt] (topleft.east) -- (bottomright) node[pos=0.9, above] {p};

                \draw[->,line width=1pt] (bottomleft.east) -- (bottomright.west) node[midway, above] {1-p};
                \draw[->,line width=1pt] (bottomleft.east) -- (topright)  node[pos=0.9, below] {p};
            \end{tikzpicture}
        \end{center}

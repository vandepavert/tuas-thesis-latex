...
%                \bitbox{#1}{}
    ...
    \begin{figure}[h!tp]
        ...
        \begin{tikzpicture}[
            ...
            % 24 audio symbols
            \node(audio) [sample,below=2cm of samples] {\symbols[2]{24}{24}{ }};
            ...
            % 33 data symbols
            \node(data) [sample,below=1cm of audio] {\symbols[2]{33}{24}{ }};
            ...
            % 588 channel bits
            \node(channel) [sample,below=2cm of data] {\symbols[2]{33}{24}{ }};
